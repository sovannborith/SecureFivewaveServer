...
@Slf4j
public class AccountVerficationRepositoryImpl implements IAccountVerficationRepository<AccountVerification> 

{
	...
	@Override
	public List<AccountVerification> list(int page, int pageSize) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public AccountVerification get(Long id) {
		// TODO Auto-generated method stub
		return null;
	}
