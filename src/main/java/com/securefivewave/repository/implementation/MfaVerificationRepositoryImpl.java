...
import com.securefivewave.repository.IMfaVerificationRepository;
...
@Slf4j
public class MfaVerificationRepositoryImpl implements IMfaVerificationRepository<MfaVerification> 

{
	...
	@Override	
	public MfaVerification create(MfaVerification mfaVerification) {
	...
	@Override
	public List<MfaVerification> list(int page, int pageSize) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public MfaVerification get(Long id) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public MfaVerification update(MfaVerification mfaVerification) {
		// TODO Auto-generated method stub
		return null;
	}
